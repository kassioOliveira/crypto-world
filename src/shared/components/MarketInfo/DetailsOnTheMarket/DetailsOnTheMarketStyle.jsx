...
export const DetailsOnTheMarketDetailsContainer = styled.section`
    width:100%;
    height:300px;
    display:flex;
    align-items:center;
...
export const DetailsSubBox = styled.div`
    ...
    display:flex;
    flex-direction:column;
    justify-content:${({d}) => d ? d : "space-around"};
    align-items:center;
...
export const IconArrownDownDetails = styled(RiArrowDownSFill)`
font-size: 30px;
color:${({c}) =>  c.isPositive === 1 || 0 ? '#0ac00a': 'red'};

`

export const IconArrownUpDetails = styled(RiArrowUpSFill)`
font-size: 30px;
color:${({c}) =>  c.isPositive === 1 || 0 ? '#0ac00a': 'red'}
`
...
`
export const ChangePercent24Hr = styled.span`
font-weight:bold;
font-size:20px;
display:flex;
align-items:center;
justify-content:center;
color:${({c}) => c &&  c.isPositive === 1 | 0 ? '#0ac00a': 'red'};
